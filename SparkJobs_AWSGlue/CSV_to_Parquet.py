...
## @return: datasource0
## @inputs: []
videoDataSource0 = glueContext.create_dynamic_frame.from_catalog(
    database = "video-data",
    table_name = "raw-csv_raw_statistics",
    transformation_ctx = "videoDataSource0",
...
datasink4 = glueContext.write_dynamic_frame.from_options(
    ...
    connection_type = "s3", 
    connection_options = {
        "path": "s3://youtube-project-1/output/video_data/",
